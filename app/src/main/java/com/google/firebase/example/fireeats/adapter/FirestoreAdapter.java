...
public abstract class FirestoreAdapter<VH extends RecyclerView.ViewHolder>
    ...
    /**
     * Note: this codelab demonstrates the real-time capabilities of Firestore,
     * but it's also simple to fetch data without a listener.
     * You can call get() on any query or reference to fetch a data snapshot.
